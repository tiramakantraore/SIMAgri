...
class SecurityTagLib {
    ...
    def ifAdmin = { attrs, body ->
        ...
        if (SpringSecurityUtils.ifAllGranted('ROLE_ADMIN')|| SpringSecurityUtils.ifAllGranted('ROLE_SUPERVISEUR')||SpringSecurityUtils.ifAllGranted('ROLE_SUPER_ADMIN')) {
            out << body()
        }
    }
    def ifSuperViseur = { attrs, body ->


        if (SpringSecurityUtils.ifAllGranted('ROLE_SUPERVISEUR')||SpringSecurityUtils.ifAllGranted('ROLE_SUPER_ADMIN')) {
            out << body()
        }
    }
    def ifSuperAdmin = { attrs, body ->
