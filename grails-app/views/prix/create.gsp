...
<html>
	<head>
		...
		<title><g:message code="create.prix" /></title>
	</head>
	<body>
		<div class="row">
			...
			<div class="col-sm-8 col-md-8">
				...
				<div class="page-header">
					<h1><g:message code="create.prix"/></h1>
				</div>
						...
						<fieldset>
                           <g:render template="form"/>
							<div class="form-actions">
								 <div  class="btn-flat  btn-primary" onclick="submitForm($(this).closest('form'), '${createLink(controller:'prix', action:'create')}','','La validation de la page  a réussi','listContent');return false;" >
