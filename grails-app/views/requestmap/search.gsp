...
%>
	...
	<table>
		<thead>
		<tr>
			<util:remoteSortableColumn update="listContent" action="list" property="url" title="${message(code: 'requestmap.url.label', default: 'URL')}" params="${queryParams}"/>
			<util:remoteSortableColumn update="listContent" action="list" property="configAttribute" title="${message(code: 'requestmap.configAttribute.label', default: 'Config Attribute')}" params="${queryParams}"/>
		</tr>
		</thead>
		<tbody>
	...
	<div class="paginateButtons">
		<util:remotePaginate update="listContent" action="list"  total="${totalCount}" params="${queryParams}" />
	</div>
