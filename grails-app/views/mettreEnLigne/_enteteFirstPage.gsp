...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <f:field  property="market" label="${g.message(code:"selectionnerMarche.text", default:"Veuillez sélectionner le marché")}" >
...
<div class="row">
    <div class="col-sm-3 col-md-3 ">
        ...
        <f:field property="date">
            <div data-date-format="dd/mm/yyyy" id='ancreDate'>
