...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'stockMagazin.magazin.label', default: 'Magazin')}" />
    		<title><g:message code="stockMagazin.label" /></title>
	</head>
	<body>
                        <g:form class="form-horizontal" action="saisie" >
                            <g:render template="/stockMagazin/saisiestocks"/>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            valider.click(function() {
                var gridData = jqStock.getRowData();
...
//            magazin.multiselect({minWidth:300,selectedList:200,height: 250,checkAllText: "Tous",uncheckAllText: "Aucun",multiple:false,
//                noneSelectedText:"Aucun marché ",selectedText: "# de # selectionnés"}).multiselectfilter({label:"Filtre",width:150,placeholder:"Entrez un mot clé"});
//
//
//            magazin.change(function() {
//                reloadGrid();
//            });
