...
<ul class="nav pull-left navbar-custom navbar-nav " style="padding-left:100px">
        ...
        <sec:ifLoggedIn>
            <li data-render-menu="accueil" class="${((activeMenu=='Accueil')||(activeMenu==null))?'active':''}">
                ...
                %{--</g:link>--}%
                <g:link controller="home" action="accueil" ><strong>Accueil</strong>
                </g:link>
             </li>
            ...
            <g:link controller="dashboard" action="accueil" ><strong>Tableau de bord</strong>
            </g:link>
            </li>
            <li data-render-menu="mettreEnLigne" class="${(activeMenu=='MiseEnLigne')?'active':''}" >
                <g:link mapping="listeMiseEnLigne"  ><strong>Mises en ligne</strong></g:link>
            ...
            <sec:ifAdmin>
                <li data-render-menu="listes" class="${(activeMenu=='Listes')?'active':''}">
                    <g:link controller="listes" action="show" ><strong>Listes</strong>
                    </g:link>
                </li>
            </sec:ifAdmin>
            <li data-render-menu="applications" class="${(activeMenu=='Applications')?'active':''}">
                <g:link controller="applications" action="show" ><strong>Applications</strong>
                </g:link>
            </li>

            <sec:ifAdmin  >
                <li data-render-menu="administration" class="${(activeMenu=='Administration')?'active':''}">
                    <g:link controller="administration" action="show" ><strong>Admin</strong>
                    </g:link>
                </li>
            </sec:ifAdmin>
            <li data-render-menu="profil" class="${(activeMenu=='Profil')?'active':''}">
                <g:link controller="utilisateur" action="editProfile" params="[isChange:'true']" >
