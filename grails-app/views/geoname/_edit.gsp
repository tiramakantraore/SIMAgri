...
<body>
<a href="#edit-geoname" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-geoname" class="content scaffold-edit" role="main">
    <h1><g:message code="edit.geoname"/></h1>
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${geonameInstance?.version}"/>
        <fieldset class="form">
