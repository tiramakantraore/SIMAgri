...
<div class="fieldcontain ${hasErrors(bean: questionChoixMultipleInstance, field: 'question', 'error')} required col-sm-12 col-md-12">
    ...
    <g:textField name="question" maxlength="150" required="" value="${questionChoixMultipleInstance?.question}" class="col-sm-7 col-md-7 offset-5" autocomplete="off"/>
</div>
</div>
...
<div class="row">
    <div class="fieldcontain ${hasErrors(bean: questionChoixMultipleInstance, field: 'options', 'error')} col-sm-12 col-md-12">
        ...
        %{--</label>--}%
        <g:render template="optionsEdit" model="['questionChoixMultipleInstance':questionChoixMultipleInstance]" />
    </div>
</div>