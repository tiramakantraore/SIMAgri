...
<div class="row">
    <div class="col-sm-6 col-md-6  ">
        <h2><g:message code="validerInfos.label"/></h2>
    </div>
</div>

<g:form class="form-horizontal" action="validerInfo" >
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
            	...
            	jqGridPrice.jqGrid({
                    url:"${createLink(controller:'info', action:'populate')}",
                    datatype: 'json',
...
//                    width:"900",
                ...
                valider.click(function() {
                    ...
                    alert("Vous devez sélectionner au moins une information ");
                        ...
                        var jqxhr =$.ajax({
                            type: "POST",
                            url: "${createLink(controller:'info', action:'valider')}",
                            ...
                            jqGridPrice.setGridParam({url: "${createLink(controller:'info', action:'populate')}"}).trigger("reloadGrid");
                ...
                rejeter.click(function() {
                    ...
                    if (postData===""){
                        ...
                        var jqxhr =$.ajax({
                            type: "POST",
                            url: "${createLink(controller:'info', action:'rejeter')}",
                            data: {selectedList: JSON.stringify(postData)},
                            dataType:"text",
                            cache: false,
                            beforeSend: function( xhr ) {
