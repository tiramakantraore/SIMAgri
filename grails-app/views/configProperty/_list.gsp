                    ...
                    <g:each in="${comparedProperties}" status="i" var="comparedProperty">
                        <tr>
                            ...
                            <g:if test="${comparedProperty.dbId != null}">
                                <g:remoteLink onLoading="showSpinner();" onComplete="hideSpinner()" controller="configProperty" action="edit" update="listContent" method="GET"
                                              id="${comparedProperty.dbId}" params="[update:'listContent']" class="btn-flat  btn-small">
                                    ${fieldValue(bean: comparedProperty, field: "configKey")}</g:remoteLink>
