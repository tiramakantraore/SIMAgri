...
<h1><g:message code="envoyerSMS" /></h1>
<g:form name="sendSMSForm" class="form-horizontal" >


    <g:hiddenField name="ReseauxIdsSMS" />
    <div class="form-actions">
        <div type="button" class="btn-flat  btn-primary validerSMS" onclick="updateReseauxIds();">
...
<ul class="nav nav-pills" id="IdSMSFormTab">
    ...
    <li><a href="#IdDestinatairesSMS" data-toggle="tab" title="Choisir le(s) destinataires du sms"> 2. Destinataires SMS </a></li>
    <li><a href="#idMessageSMS" data-toggle="tab" title="Ecrire le message"> 3. Message SMS </a></li>
</ul>
...
<g:render template="/applications/smsjs"/>