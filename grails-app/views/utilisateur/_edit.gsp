                ...
                <g:form name="edit" class="form-stacked-vertical" enctype="multipart/form-data"  >
                    ...
                    <g:hiddenField name="isCreation" value="${isCreation}" />
                            ...
                            <ul class="nav nav-pills" id="dashboardTab">
                                ...
                                <li><a href="#IdMarches" data-toggle="tab">${g.message(code:"mesMarchesSuivi.label", default:"Mes marchés (suivi)")}</a></li>
                                <sec:ifSuperViseur>
                                <li><a href="#IdMarchesMiseEnLigne" data-toggle="tab">${g.message(code:"mesMarchesEnLigne.label", default:"Mes marchés (Mise en ligne)")}</a></li>
                                </sec:ifSuperViseur>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-11 col-md-11 col-sm-offset1 col-md-offset1">
                                            <div id="listeRegions" style="max-height: 400px;overflow-y:scroll ">
                                                <bill:checkBoxList referenceCollection="${simagri.Region.list()}" containerClass="my4Columns" title="${g.message(code:"regions.text", default:"Régions")}" instanceName="regions" onClickCheck="regionClick();"  />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3">
                                            <a id="check-allMarkets" href="javascript:void(0);">${g.message(code:"tousLesMarches.text", default:"${g.message(code: "tousLesMarches.text", default:"Tous les marchés")}")}</a>
                                        </div>
                                        <div class="col-sm-3 col-md-3">
                                            <a id="uncheck-allMarkets" href="javascript:void(0);">${g.message(code:"aucunMarche.text", default:"${g.message(code: "aucunMarche.text", default:"Aucun marché")}")}</a>
                                        </div>
                                    </div>
                                ...
                                <sec:ifSuperViseur>
                                            <div class="tab-pane" id="IdMarchesMiseEnLigne">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 col-sm-offset1 col-md-offset1">
                                                        <div id="listeRegionsMEL" style="max-height: 400px;overflow-y:scroll ">
                                                            <bill:checkBoxList referenceCollection="${simagri.Region.list()}" containerClass="my4Columns" title="${g.message(code:"regions.text", default:"Régions")}" instanceName="regionsMEL" onClickCheck="regionMELClick();"  />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3 col-md-3">
                                                        <a id="check-allMarketsMiseEnLigne" href="javascript:void(0);">${g.message(code:"tousLesMarches.text", default:"Tous les marchés")}</a>
                                                    </div>
                                                    <div class="col-sm-3 col-md-3">
                                                        <a id="uncheck-allMarketsMiseEnLigne" href="javascript:void(0);">${g.message(code:"aucunMarche.text", default:"Aucun marché")}</a>
                                                    </div>
                                                </div>
                                            <div id="marketsMEL">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-11 col-md-11 col-sm-offset1 col-md-offset1">
                                            <div id="listeCategories" style="max-height: 400px;overflow-y:scroll ">
                                                <bill:checkBoxList referenceCollection="${CategorieProduit.findAllByActif(true)}" containerClass="my4Columns" title="Catégories de produits" instanceName="categories" onClickCheck="categorieClick();"  />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
