    ...
    <div class="tab-pane" id="idPrixForm">
        ...
        <ul class="nav nav-pills" >
            ...
            <li><a href="#IdOffresAValider" data-toggle="tab" title="${g.message(code:"offreAValider.text", default:"Offres à valider")}"> ${g.message(code:"offreAValider.text", default:"Offres à valider")} </a></li>
            <li><a href="#IdOffresValides" data-toggle="tab" title="${g.message(code:"offreValides.text", default:"Offres validées ")}">${g.message(code:"offreValides.text", default:"Offres validées ")}  </a></li>
            <li><a href="#IdOffresRejetes" data-toggle="tab" title="${g.message(code:"offreRejetes.text", default:"Offres rejétées ")}">${g.message(code:"offreRejetes.text", default:"Offres rejétées ")}</a></li>
        </ul>
        <div class="tab-content">

            <div class="tab-pane active" id="IdOffresAValider">
                <div id="listOffresAValiderContent">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 workarea">
                            ...
                            <export:formats controller="offre" action="list" formats="['csv', 'excel', 'pdf']" />
                        </div>
                    ...
                    %{--<filterpane:filterPane controller="offre"  associatedProperties="produit.nom, lieuStockage.nom,mesure.nom,qualite.nom,origine.nom,lieuLivraison.nom,auteur.login"--}%
                                           %{--excludeProperties="email,delaiEnJours,quantite,dateValidation, dateExpiration,delaiLivraison,isValidated,coutTransport,commentaire,conditions,prixUnitaireGros,prixTotalGros,contact,IsForSell" dialog="true" domain="simagri.Offre" />--}%

                </div>

             </div>
            <div class="tab-pane " id="IdOffresValides">
                <div id="listOffresValidesContent">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 workarea">
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                <g:each in="${offreValideInstanceList}" var="offreInstance">
                                    <tr>
                                        <td class="link">
                            ...
                            <div class="pagination">
                                <util:remotePaginate controller="offre" update="listOffresValidesContent" action="listValidees"  total="${offreValideInstanceTotal}" params="${filterParams}" />
                            </div>
                            <export:formats controller="offreValidee" action="list" formats="['csv', 'excel', 'pdf']" />
                        </div>
            ...
            <div class="tab-pane" id="IdOffresRejetes" >
            <g:render template="/offre/abandonner"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       ...
       $('a[href="#IdOffresAValider"]').tab('show');
    });
