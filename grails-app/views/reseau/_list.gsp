%{--<div class="row">--}%
    ...
    %{--<div class="col-sm-8 col-md-8">--}%
        %{--<div class="page-header">--}%
            %{--<h1><g:message code="list.reseau" /></h1>--}%
        %{--</div>--}%
    %{--</div>--}%
%{--</div>--}%
				...
				<table class="table ">
					<thead>
                        ...
                        <th></th>
                            ...
                            <th class="header"><g:message code="reseau.parent.label" default="Parent" /></th>    --}%
                            <util:remoteSortableColumn update="listContent" action="list" property="nom" title="${message(code: 'reseau.nom.label', default: 'Nom')}" />
                            %{--<th class="header"><g:message code="reseau.nom.label" default="Nom" /></th>--}%
                            ...
                            <th class="header"><g:message code="reseau.nbMembres.label" default="Nbre membres" /></th>
						</tr>
					</thead>
					<tbody>
					<g:each in="${reseauInstanceList}" var="reseauInstance">
						...
						%{----}%
                            ...
                            <td>${fieldValue(bean: reseauInstance, field: "nbTotalMembres")}</td>
						</tr>
					</g:each>
					</tbody>
				</table>
