...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Vérifier ma réponse !',
                nextQuestionText: 'Suivant &raquo;',
                backButtonText: 'Précédent &raquo;',
                completeQuizText: '',
                tryAgainText: 'Rejouer',
                questionCountText: 'Question %current de %total',
