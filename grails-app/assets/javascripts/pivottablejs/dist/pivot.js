...
(function() {
  ...
  PivotData = (function() {
    function PivotData(input, opts) {
      ...
      this.pivotId = opts.pivotId;
      this.pivotContainerId = opts.pivotContainerId;
      this.tree = {};
      this.rowKeys = [];
      this.colKeys = [];
      this.rowTotals = {};
  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
    var a, aggregator, attrLength, axisValues, c, colList, defaults, e, existingOpts, i, initialRender, k, opts, pivotTable, refresh, refreshDelayed, renderer, rendererControl, shownAttributes, tblCols, tr1, tr2, uiTable,responsiveDiv, unusedAttrsVerticalAutoOverride, x, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4;
    if (overwrite == null) {
      overwrite = false;
    }
    if (locale == null) {
    ...
    try {
     ...
     // responsiveDiv=$("<div class='table-responsive' style='margin:0 auto;max-width:600px;overflow:scroll '>");
      uiTable = $("<table cellpadding='1'>");
     //   uiTable = $("<table class='footable'>");
...
//        return refresh();
//      });pvtRenderer
        renderer = $("<div class='pvtRenderer  radioboxbg my2Columns' >").appendTo(rendererControl).bind("change", function() {
...
//      }
        ...
        for (x in _ref1) {
          if (!__hasProp.call(_ref1, x)) continue;
           var liste= $("<li class='pvtRendererUnliststyle '> </li>").appendTo(renderer);
		   if (index==0) {
		    $("<input type='radio' name='renderChoice' checked='checked'  class='pvtRenderermyRadiostyle'>").val(x).html("").appendTo(liste);
		   }else {
		    $("<input type='radio' name='renderChoice'  class='pvtRenderermyRadiostyle'>").val(x).html("").appendTo(liste);
		   }
		  
           $("<label for="+x+" class='labelClass' data-toggle='tooltip'  title="+x+">").val(x).html(x).appendTo(liste);
            index++;
        }
      ...
      _fn = function(c) {
        ...
        if (keys.length > opts.menuLimit) {
          ...
          btns.append($("<input>").addClass("pvtSearch").attr("placeholder", opts.localeStrings.filterResults).bind("keyup", function() {
            ...
            btns.append($("<button>").text("OK").bind("click", updateFilterbefore));
...
//                top: e.pageY
      ...
      refreshDelayed = (function(_this) {
        return function() {
          var attr, exclusions, natSort, newDropdown, numInputsToProcess, pivotUIOptions, pvtVals, subopts, unusedAttrsContainer, vals,pivotId,pivotContainerId, _len4, _m, _n, _ref5;
          subopts = {
          ...
          if (numInputsToProcess !== 0) {
            ...
            pivotId= opts.pivotId;
            pivotContainerId= opts.pivotContainerId;
          if (initialRender) {
            vals = opts.vals;
          ...
          subopts.vals = vals;
          subopts.pivotId = pivotId;
          subopts.pivotContainerId = pivotContainerId;
          subopts.aggregator = opts.aggregators[aggregator.val()](vals);

            var renderedsel=$("input:radio[name='renderChoice']:checked").val();
          subopts.renderer = opts.renderers[renderedsel];
          exclusions = {};
          ...
          subopts.filter = function(record) {
            ...
            for (k in exclusions) {
                if (exclusions.hasOwnProperty(k)) {
          ...
          pivotUIOptions = $.extend(opts, {
            ...
            rows: subopts.rows,
            pivotId : pivotId,
            pivotContainerId :pivotContainerId,
            vals: vals,
