...
(function() {
  ...
  $.pivotUtilities.locales.fr = {
    ...
    renderers: {
      ...
      "Barres": $.pivotUtilities.gchart_renderers["Bar Chart"],
   //   "Histogramme-Vertical":$.pivotUtilities.gchart_renderers["bar"],
      "Lignes":$.pivotUtilities.gchart_renderers["Line Chart"],
      "Aires":$.pivotUtilities.gchart_renderers["Area Chart"],
     "Camembert":$.pivotUtilities.gchart_renderers["Pie Chart"],
     "Barres Empilées":$.pivotUtilities.gchart_renderers["Stacked Bar Chart"]
