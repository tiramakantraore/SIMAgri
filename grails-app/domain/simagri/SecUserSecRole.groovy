...
class SecUserSecRole implements Serializable {
    ...
    static boolean remove(SecUser u, SecRole r, boolean flush = true) {
    ...
    static void removeAll(SecUser u, boolean flush = true) {
        if (u == null) return
    ...
    static void removeAll(SecRole r, boolean flush = true) {
        if (r == null) return
