...
class gsp_SIMAgri_questionChoixMultiple_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/questionChoixMultiple/_form.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('textField','g',20,['name':("question"),'maxlength':("200"),'required':(""),'value':(questionChoixMultipleInstance?.question),'class':("col-sm-7 col-md-7 offset-5"),'autocomplete':("off")],-1)
printHtmlPart(5)
...
printHtmlPart(12)
invokeTag('render','g',62,['template':("options"),'model':(['questionChoixMultipleInstance':questionChoixMultipleInstance])],-1)
printHtmlPart(13)
}
...
public static final long LAST_MODIFIED = 1407035061188L
