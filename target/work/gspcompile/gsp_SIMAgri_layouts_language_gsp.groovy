...
class gsp_SIMAgri_layouts_language_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/_language.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
expressionOut.print(resource(dir: 'images/flags',file: lang.toString()+'.png'))
printHtmlPart(2)
expressionOut.print(currentURL+'?lang=en')
printHtmlPart(3)
expressionOut.print(resource(dir: 'images/flags',file: 'en.png'))
printHtmlPart(4)
invokeTag('message','g',14,['code':("language.en"),'default':("en")],-1)
printHtmlPart(5)
...
printHtmlPart(11)
expressionOut.print(resource(dir: 'images/flags',file: locale+'.png'))
printHtmlPart(12)
invokeTag('message','g',24,['code':("language.${locale}"),'default':(locale)],-1)
printHtmlPart(13)
i++
}
}
...
public static final long LAST_MODIFIED = 1350828894214L
