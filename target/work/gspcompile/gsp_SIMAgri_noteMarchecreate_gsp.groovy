...
class gsp_SIMAgri_noteMarchecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/noteMarche/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',46,['bean':(noteMarcheInstance),'var':("error")],4)
printHtmlPart(18)
})
invokeTag('alert','bootstrap',46,['class':("alert-error")],3)
printHtmlPart(10)
})
invokeTag('hasErrors','g',46,['bean':(noteMarcheInstance)],2)
printHtmlPart(19)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1455374984939L
