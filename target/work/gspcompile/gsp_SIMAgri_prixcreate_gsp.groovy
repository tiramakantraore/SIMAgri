...
class gsp_SIMAgri_prixcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/prix/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',8,['code':("create.prix")],-1)
})
...
printHtmlPart(9)
invokeTag('message','g',36,['code':("create.prix")],-1)
printHtmlPart(10)
...
invokeTag('eachError','g',48,['bean':(prixInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',50,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',51,['bean':(prixInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('render','g',55,['template':("form")],-1)
printHtmlPart(22)
expressionOut.print(createLink(controller:'prix', action:'create'))
printHtmlPart(23)
...
public static final long LAST_MODIFIED = 1423423410361L
