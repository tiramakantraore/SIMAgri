...
class gsp_SIMAgri_smsToReseauxedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/smsToReseaux/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("edit.smsToReseaux")],-1)
})
...
printHtmlPart(9)
invokeTag('message','g',35,['code':("edit.smsToReseaux")],-1)
printHtmlPart(10)
...
invokeTag('eachError','g',47,['bean':(smsToReseauxInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',49,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',50,['bean':(smsToReseauxInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(smsToReseauxInstance?.version)],-1)
printHtmlPart(22)
invokeTag('render','g',56,['template':("form")],-1)
printHtmlPart(23)
expressionOut.print(createLink(controller:'smsToReseaux', action:'edit'))
printHtmlPart(24)
...
invokeTag('form','g',68,['class':("well small form-horizontal"),'action':("edit"),'id':(smsToReseauxInstance?.id)],2)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1423423410142L
