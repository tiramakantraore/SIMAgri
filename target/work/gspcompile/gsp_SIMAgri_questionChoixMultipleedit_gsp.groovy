...
class gsp_SIMAgri_questionChoixMultipleedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/questionChoixMultiple/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("edit.questionChoixMultiple")],-1)
})
...
printHtmlPart(9)
invokeTag('message','g',35,['code':("edit.questionChoixMultiple")],-1)
printHtmlPart(10)
...
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(questionChoixMultipleInstance?.version)],-1)
printHtmlPart(22)
invokeTag('render','g',56,['template':("formEdit")],-1)
printHtmlPart(23)
expressionOut.print(createLink(controller:'questionChoixMultiple', action:'edit'))
printHtmlPart(24)
...
invokeTag('form','g',68,['class':("well small form-horizontal"),'action':("edit"),'id':(questionChoixMultipleInstance?.id)],2)
printHtmlPart(28)
invokeTag('render','g',72,['template':("option"),'model':(['option':null,'i':'-1','hidden':true])],-1)
printHtmlPart(29)
})
...
public static final long LAST_MODIFIED = 1423423410953L
