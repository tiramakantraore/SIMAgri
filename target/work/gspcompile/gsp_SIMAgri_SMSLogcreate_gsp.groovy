...
class gsp_SIMAgri_SMSLogcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/SMSLog/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("create.SMSLogger")],-1)
})
...
printHtmlPart(9)
invokeTag('message','g',35,['code':("create.SMSLogger")],-1)
printHtmlPart(10)
...
printHtmlPart(22)
expressionOut.print(createLink(controller:'pageUtilisateur', action:'create'))
printHtmlPart(23)
...
public static final long LAST_MODIFIED = 1423423410868L
