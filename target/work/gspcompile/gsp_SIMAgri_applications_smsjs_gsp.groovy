...
class gsp_SIMAgri_applications_smsjs_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/applications/_smsjs.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
expressionOut.print(createLink(controller:'smsToReseaux', action:'sendByService'))
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1442327098185L
