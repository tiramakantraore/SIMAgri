...
class gsp_SIMAgri_requestmapsearch_gsp extends GroovyPage {
...
printHtmlPart(11)
invokeTag('remoteSortableColumn','util',50,['update':("listContent"),'action':("list"),'property':("url"),'title':(message(code: 'requestmap.url.label', default: 'URL')),'params':(queryParams)],-1)
printHtmlPart(12)
invokeTag('remoteSortableColumn','util',51,['update':("listContent"),'action':("list"),'property':("configAttribute"),'title':(message(code: 'requestmap.configAttribute.label', default: 'Config Attribute')),'params':(queryParams)],-1)
printHtmlPart(13)
loop:{
int i = 0
...
printHtmlPart(18)
invokeTag('remotePaginate','util',66,['update':("listContent"),'action':("list"),'total':(totalCount),'params':(queryParams)],-1)
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1442325557765L
