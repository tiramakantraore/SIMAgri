...
class gsp_SIMAgri__fields_produit_actif_field_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/_fields/produit/actif/_field.gsp" }
public Object run() {
Writer out = getOut()
