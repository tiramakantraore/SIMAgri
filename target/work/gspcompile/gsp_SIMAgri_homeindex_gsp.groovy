...
class gsp_SIMAgri_homeindex_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',41,['class':("no-left-padding no-right-padding")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1442329663194L
