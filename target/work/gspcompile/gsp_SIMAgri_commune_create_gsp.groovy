...
class gsp_SIMAgri_commune_create_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/commune/_create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(12)
invokeTag('field','f',20,['bean':("communeInstance"),'property':("nom"),'input-class':("form-control")],-1)
printHtmlPart(12)
invokeTag('field','f',21,['bean':("communeInstance"),'property':("province"),'input-class':("form-control")],-1)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1416953972704L
