...
class gsp_SIMAgri_activite_create_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/activite/_create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',15,['bean':(activiteInstance),'var':("error")],3)
printHtmlPart(10)
})
invokeTag('alert','bootstrap',17,['class':("alert-error")],2)
printHtmlPart(2)
})
invokeTag('hasErrors','g',18,['bean':(activiteInstance)],1)
printHtmlPart(11)
createTagBody(1, {->
printHtmlPart(12)
...
public static final long LAST_MODIFIED = 1416848441537L
