...
class gsp_SIMAgri_region_create_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/region/_create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(12)
invokeTag('field','f',19,['bean':("regionInstance"),'property':("nom"),'input-class':("form-control")],-1)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1416848069808L
