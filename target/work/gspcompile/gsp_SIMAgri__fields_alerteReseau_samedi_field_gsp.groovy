...
class gsp_SIMAgri__fields_alerteReseau_samedi_field_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/_fields/alerteReseau/samedi/_field.gsp" }
public Object run() {
Writer out = getOut()
