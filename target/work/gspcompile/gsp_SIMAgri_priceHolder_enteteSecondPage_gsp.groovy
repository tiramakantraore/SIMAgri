...
class gsp_SIMAgri_priceHolder_enteteSecondPage_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/priceHolder/_enteteSecondPage.gsp" }
public Object run() {
Writer out = getOut()
