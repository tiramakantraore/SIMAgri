...
class gsp_SIMAgri_home_accueilBFA_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/home/_accueilBFA.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('video','g',28,['videoKey':(videoInstance?.url?.split('=')?.size()>1?videoInstance?.url?.split('=')[1]:""),'width':("100%"),'height':("250px")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1423421105968L
