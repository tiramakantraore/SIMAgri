...
class gsp_SIMAgri_categorieProduit_create_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/categorieProduit/_create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',23,['class':("form-horizontal"),'action':("create"),'enctype':("multipart/form-data")],1)
printHtmlPart(14)
}
...
public static final long LAST_MODIFIED = 1417060869822L
