...
class gsp_SIMAgri_loginauth_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',3,['gsp_sm_xmlClosingForEmptyTag':("/"),'name':("layout"),'content':("indexLayout")],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
public static final long LAST_MODIFIED = 1413701065846L
