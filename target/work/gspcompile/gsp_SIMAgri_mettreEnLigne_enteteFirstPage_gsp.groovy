...
class gsp_SIMAgri_mettreEnLigne_enteteFirstPage_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mettreEnLigne/_enteteFirstPage.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('field','f',8,['property':("market"),'label':(g.message(code:"selectionnerMarche.text", default:"Veuillez sélectionner le marché"))],1)
printHtmlPart(3)
createTagBody(1, {->
printHtmlPart(4)
...
public static final long LAST_MODIFIED = 1444686177664L
