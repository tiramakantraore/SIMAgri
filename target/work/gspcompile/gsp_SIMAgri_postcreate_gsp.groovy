...
class gsp_SIMAgri_postcreate_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("create.post")],-1)
})
...
printHtmlPart(9)
invokeTag('message','g',35,['code':("create.post")],-1)
printHtmlPart(10)
...
createTagBody(2, {->
printHtmlPart(21)
invokeTag('all','f',55,['bean':(postInstance)],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1423423411637L
