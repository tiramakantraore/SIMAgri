...
class gsp_dynamicDbConfigProperty_configProperty_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/dynamic-db-config-property-0.4.0.9/grails-app/views/configProperty/_form.gsp" }
public Object run() {
Writer out = getOut()
